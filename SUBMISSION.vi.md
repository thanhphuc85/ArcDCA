...
- **Vitest** — 39 unit test cho các đường đi quan trọng về an toàn: guardrail `clampDecision()`, phần quyết toán pro-rata khi gộp lệnh (gồm cả gộp-theo-token), và phép tính số ngày outage/campaign mà agent dùng để lý luận
